      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8 px-2">
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold leading-tight">
            <span className="block text-gradient glow-effect">FUTURE</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
            <Button size="lg" className="group" asChild>
              <a href="#services" aria-label="Explore our web development services">
                Explore Services
                <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </a>
            </Button>
            <Button size="lg" variant="outline" asChild>
              <a href="#contact" aria-label="Get started with your project">Get Started</a>
            </Button>
          </div>
        </div>
      </div>
