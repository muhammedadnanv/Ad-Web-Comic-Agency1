...
const FreelancerOS = () => {
  ...
  return (
    <section id="freelancer-os" className="py-20 bg-background">
      <div
        ref={ref as any}
      ...
      >
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4 text-foreground">Join Freelancer OS</h2>
